...
if __name__ == "__main__":
    ...
    parser.add_argument("--coeff-start", type=int, default=50, help="Start of coefficient range")
    parser.add_argument("--coeff-end", type=int, default=250, help="End of coefficient range")
